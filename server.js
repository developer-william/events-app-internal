...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'some cool place'},
        { title: 'another event', id: 2, description: 'something even cooler' , location: 'another cool place'}
    ]
};
